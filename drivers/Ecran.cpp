...
void Ecran::effacerEcran(Couleur arPlan) {
    ...
    for (int pos = 0; pos < LIGNES * COLONNES; pos++) {
...
// gere le d�filement de nline d'un coup. les nouvelles lignes ont pour fond la couleur de fond courante
...
// A FAIRE POUR CEUX QUI S'ENNUIENT
}

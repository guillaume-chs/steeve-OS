...
//#include <sos/klibc.h>
//#include <kerminator/assert.h>
//#include <kerminator/list.h>
 ...
 */
static sextant_ret_t add_in_ready_queue(struct thread *thr,
				    bool insert_at_tail)
{
  int i;
  int fin=0;
...
struct thread * reschedule(struct thread *current_thread,
				   bool do_yield)
{
